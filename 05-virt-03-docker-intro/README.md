...
### Решение:
- [https://hub.docker.com/repository/docker/sokolkovnetology/custom-nginx/general](https://hub.docker.com/repository/docker/sokolkovnetology/custom-nginx/general)
- ![image](https://github.com/user-attachments/assets/8601828c-8ab4-4c30-8695-52c6a0713580)
...
В качестве ответа приложите скриншоты консоли, где видно все введенные команды и их вывод.
### Решение:
- 1-4 (почему контейнер остановился: мы подключились к основному процессу командой attach, т.к. основной процесс относится к nginx, то при отправке ctrl+c выполняется завершение процесса, то бишь nginx'a)
лучше использовать docker exec через баш и docker logs для логов
